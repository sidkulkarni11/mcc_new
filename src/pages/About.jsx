...
export default function About() {
    ...
    // Pre-filled WhatsApp message (Booking with Nisha)
    ...
    return (
        ...
        >
            <div
                className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-20 items-center animate-fadeIn"
            >
                {/* IMAGE */}
                ...
                <div className="pr-4">
                    ...
                    {/* CTA BUTTON WITH WHATSAPP MESSAGE */}
                    <a
                        href={`https://wa.me/917977482411?text=${whatsappMessage}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="mt-10 inline-block px-8 py-4 bg-[#0D3B66] text-white rounded-full text-lg shadow-lg hover:bg-[#0a2d52] transition"
                    >
